...
class UfHeaderList extends TPage
{
    private $form; // form
    ...
    private static $database = 'starter';
    ...
    public function __construct($param = null)
    {
        ...
        $column_nome = new TDataGridColumn('nome', "UF", 'left');
        ...
        $action_onDelete = new TDataGridAction(array('UfHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de ufs");
        ...
        $button_cadastrar->setAction(new TAction(['UfForm', 'onShow']), "Cadastrar");
        ...
        $dropdown_button_exportar->addPostAction( "CSV", new TAction(['UfHeaderList', 'onExportCsv'],['static' => 1]), self::$formName, 'fas:file-csv #00b894' );
        $dropdown_button_exportar->addPostAction( "XLS", new TAction(['UfHeaderList', 'onExportXls'],['static' => 1]), self::$formName, 'fas:file-excel #4CAF50' );
        $dropdown_button_exportar->addPostAction( "PDF", new TAction(['UfHeaderList', 'onExportPdf'],['static' => 1]), self::$formName, 'far:file-pdf #e74c3c' );
        $dropdown_button_exportar->addPostAction( "XML", new TAction(['UfHeaderList', 'onExportXml'],['static' => 1]), self::$formName, 'far:file-code #95a5a6' );
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Básico","Ufs"]));
        }
    ...
    public function onReload($param = NULL)
    {
        try
        {
            // open a transaction with database 'starter'
            TTransaction::open(self::$database);
