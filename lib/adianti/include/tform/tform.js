        ...
        if (single_field.length || array_field.length || multifile_field) {
            ...
            if (Adianti.formEventsCounter == 0 ) {
                if(multifile_field.length) {
                    ...
                    if (single_field.attr('widget') == 'thtmleditor') {
                    ...
                    else if (single_field.attr('widget') == 'bdaterange') {
                        bdaterange_set_value('#'+single_field.attr('id'), value);
                    }
                        ...
                        if (single_field.val() !== value) {
                            ...
                            if(fire_events)
                            {
                                single_field.val(value).trigger('change');
                            } 
                            else 
                            {
                                single_field.val(value).trigger('change.select2');
                            }
                    ...
                    if (array_field.attr('type') == 'checkbox') {
                        ...
                        if (value) {
                            ...
                            if (array_field.attr('widget') == 'tselect' && array_field.length == 1) // single select[]
                            {
                                ...
                                if ($(array_field).attr('role') == 'bselectcheck') {
                                    bselectcheck_update_summary(array_field, $(array_field).attr('placeholder'));
                                }
                            }
